  ...
  const MockPicker = ({ children, onValueChange, selectedValue }: any) => {
    ...
    return (
      <View testID='picker'>
        ...
        <Pressable testID='picker-select-1' onPress={() => onValueChange(1)}>
          <Text>Select Dinner 1</Text>
        </Pressable>
        <Pressable testID='picker-select-2' onPress={() => onValueChange(2)}>
...
describe('DinnerSelector', () => {
  ...
  describe('Theme support', () => {
    it('should use light theme by default', () => {
      jest
        .spyOn(useColorSchemeModule, 'useColorScheme')
