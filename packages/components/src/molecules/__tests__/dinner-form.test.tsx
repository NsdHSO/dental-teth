...
jest.mock('@dental/i18n', () => ({
  useTranslation: jest.fn(),
}));

import { useColorScheme } from 'react-native';
import { useGlowVariant } from '../../hooks/useGlowVariant';
import { useTranslation } from '@dental/i18n';
...
describe('DinnerForm', () => {
  ...
  >;
  const mockUseGlowVariant = useGlowVariant as jest.MockedFunction<
    typeof useGlowVariant
  >;
  ...
  it('should render all input fields', () => {
    ...
    expect(
      getByPlaceholderText('supper.maxParticipantsPlaceholder'),
    ).toBeTruthy();
  });
  ...
  it('should call onSubmit with valid data', async () => {
    ...
    fireEvent.changeText(
      getByPlaceholderText('supper.dinnerDatePlaceholder'),
      '2026-03-25',
    );
    fireEvent.changeText(
      getByPlaceholderText('supper.mealTypePlaceholder'),
      'Dinner',
    );
    fireEvent.changeText(
    ...
    fireEvent.changeText(
      getByPlaceholderText('supper.locationPlaceholder'),
      'Hall',
    );
    fireEvent.changeText(
      getByPlaceholderText('supper.maxParticipantsPlaceholder'),
  ...
  it('should disable inputs when submitting', () => {
    ...
    const dinnerDateInput = getByPlaceholderText(
      'supper.dinnerDatePlaceholder',
    );
