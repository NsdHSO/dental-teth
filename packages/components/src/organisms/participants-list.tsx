...
import type { Participant } from '@dental/types';
...
export function ParticipantsList({
  ...
  if (participants.length === 0) {
    return (
      <View testID={testID}>
        <Text
          style={[styles.emptyText, { color: Colors[scheme ?? 'light'].icon }]}
        >
  ...
  return (
    <View testID={testID} style={styles.container}>
      {participants.map((participant, index) => (
        ...
        >
          <View style={styles.cardRow}>
            <Text
              style={[styles.label, { color: Colors[scheme ?? 'light'].icon }]}
            >
      ...
      <Text
        style={[styles.countText, { color: Colors[scheme ?? 'light'].icon }]}
      >
