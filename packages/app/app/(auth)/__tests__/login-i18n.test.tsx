...
jest.mock('@dental/auth', () => ({
  ...
  getBiometricPreference: (...args: any[]) =>
    mockGetBiometricPreference(...args),
}));
  ...
  describe('Biometric section strings', () => {
    ...
    it('should use t() for iOS biometric accessibility label', async () => {
      ...
      expect(mockT).toHaveBeenCalledWith(
        'auth.login.biometricAccessibilityLabel',
      );
    });
    ...
    it('should use t() for Android biometric accessibility label', async () => {
      ...
      expect(mockT).toHaveBeenCalledWith(
        'auth.login.biometricAccessibilityLabelAndroid',
      );
    });
    ...
    it('should use t() for biometric accessibility hint', async () => {
      ...
      expect(mockT).toHaveBeenCalledWith(
        'auth.login.biometricAccessibilityHint',
      );
    });
  });
  ...
  describe('Alert strings - login error', () => {
    it('should use t() for login error fallback message', async () => {
      ...
      fireEvent.changeText(
        getByPlaceholderText('auth.login.emailPlaceholder'),
        'test@test.com',
      );
      fireEvent.changeText(
        getByPlaceholderText('auth.login.passwordPlaceholder'),
        'password',
      );
