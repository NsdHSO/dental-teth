...
import { ThemedText, ThemedView, useColorScheme } from '@dental/components';
  ...
  return (
    <ThemedView className='flex-1'>
      ...
      >
        ...
        >
          Tests all expo-local-authentication APIs. Check console for detailed
          logs.
        </ThemedText>
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            <TouchableOpacity
              ...
              style={{
                flex: 1,
                backgroundColor:
                  authTestRunning || running ? '#6B7280' : '#3B82F6',
                borderRadius: 8,
                paddingVertical: 12,
                alignItems: 'center',
              }}
            ...
            <TouchableOpacity
              ...
              style={{
                flex: 1,
                backgroundColor:
                  authTestRunning || running ? '#6B7280' : '#8B5CF6',
                borderRadius: 8,
                paddingVertical: 12,
                alignItems: 'center',
              }}
        ...
        {results.length === 0 && (
          ...
          >
            ...
            >
              1. Tap &quot;Run Diagnostics&quot; to check hardware and
              enrollment status{'\n'}2. Use &quot;Auth + Fallback&quot; to test
              authentication with PIN/pattern fallback{'\n'}3. Use &quot;Auth
              Biometric Only&quot; to test biometric-only authentication{'\n'}4.
              Check Metro/Logcat console for detailed logs prefixed with
              [BiometricTest]
            </Text>
          </View>
        )}
